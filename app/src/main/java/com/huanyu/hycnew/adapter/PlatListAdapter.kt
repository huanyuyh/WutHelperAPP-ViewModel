...
class PlatListAdapter(mContext: Context, mPlatList: List<String>): BaseAdapter() {
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup?): View {
        val view: View = convertView ?: LayoutInflater.from(mContext).inflate(R.layout.item_spinner_plat, parent, false)
